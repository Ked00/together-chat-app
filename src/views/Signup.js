        ...
        <>
            ...
            <Row>
                <Col className="vh-100 d-flex justify-content-center align-items-center" xs={5}>
                    <img src={require("../images/signup-banner.png")} width="500px" height="500px" />
                </Col>
                ...
                <Col className="vh-100">
                    <Form className="h-75 d-flex flex-column justify-content-center align-items-center">
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3 w-75"
                        >
                            <Form.Control name="username" placeholder="Enter a username..." onChange={changeInput} />
                        </FloatingLabel>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3 w-75"
                        >
                            <Form.Control type="email" name="email" placeholder="Enter a email..." onChange={changeInput} />
                        </FloatingLabel>
