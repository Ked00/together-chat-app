    ...
    return (
        <>
            <Button className="border-0 bg-transparent" onClick={switchState}>
                <img src={require("../images/friends.png")} width="30px" height="30px" />
            </Button>
            ...
            <Offcanvas show={toggle} onHide={closeAll} placement="end">
                ...
                <Offcanvas.Header className="fs-2">
                    {props.user}
                </Offcanvas.Header>

                <Offcanvas.Body>
                    <div className="d-flex justify-content-center mb-5">
                        <img src={require("../images/friends.png")} width="150px" height="150px" className="border border-dark rounded-circle p-1 border-5" />
                    </div>
                    <Form>
                        <Form.Group className="mb-4">
                            <Form.Label>Update Username</Form.Label>
                            <Form.Control placeholder="Enter a new username" onChange={changeInput} name="username" />
                        </Form.Group>

                        <Form.Group className="mb-4">
                            <Form.Label>Update Password</Form.Label>
                            <Form.Control placeholder="Enter a new password" onChange={changeInput} name="password" />
                        </Form.Group>
                    </Form>
