            ...
            <Modal show={toggle} onHide={switchState}>
                ...
                <Modal.Body>
                    <Form.Group>
                        ...
                        <Form.Control value={props.roomId} onChange={props.targetFunc} name="oneinput" min={5}/>
                    </Form.Group>

                    <Button className="mt-4 w-100" href={props.href} onClick={props.onClick}>{props.submit}</Button>
                </Modal.Body>
            </Modal>
        </>
    )
